						...
						<div class="card-body">
							...
							<div>
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/templates/templateAdmin/assets/img/flag/us.jpg)"></div>
								...
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/templates/templateAdmin/assets/img/flag/cn.jpg)"></div>
									<div class="d-flex w-100">
										<div>China</div>
								...
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/templates/templateAdmin/assets/img/flag/de.jpg)"></div>
									<div class="d-flex w-100">
										<div>Germany</div>
								...
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/templates/templateAdmin/assets/img/flag/fr.jpg)"></div>
									<div class="d-flex w-100">
										<div>France</div>
								...
								<div class="d-flex align-items-center text-white mb-0">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(public/templates/templateAdmin/assets/img/flag/jp.jpg)"></div>
									<div class="d-flex w-100">
										<div>Japan</div>
						...
						<div class="card-body">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(public/templates/templateAdmin/assets/img/product/product-8.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(public/templates/templateAdmin/assets/img/product/product-9.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(public/templates/templateAdmin/assets/img/product/product-10.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(public/templates/templateAdmin/assets/img/product/product-11.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(public/templates/templateAdmin/assets/img/product/product-12.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
