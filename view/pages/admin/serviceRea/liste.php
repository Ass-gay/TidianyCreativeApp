	...
	<!-- ========= Recuperation liste servicerea Dans BD ========= -->
 	<?php
		...
		try {
			...
			// var_dump($listeServicesReas); die;
	...
	<!-- ================== SECTION BASE CONTENT ================== -->
        <div id="content" class="content">
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item"><a href="#" class="btn btn-sm btn-dark text-white fw-bold">Corbeille</a></li>
							...
							<?php if(!empty($listeServicesReas)) : ?>
								<?php foreach ($listeServicesReas as $serviceRea) : ?>
									<tr class="odd gradeX">
										...
										<td class="text-center">
											<!-- Edition -->
											 <a href="serviceReaMainController?id= <?= htmlspecialchars($serviceRea['id']); ?>&action=edit" data-toggle="tooltip" data-placement="top" title="Modifier">
